...
class ProductStorage {
    ...
    products = [
        ...
        },
        {
            ...
            mass: 100,
            description: "Древесные грибы Муэр еще называют чёрные китайские грибы. ",
            price: 145
        },
        {
            id: 5,
        ...
        },
        {
            ...
            mass: 100,
            description: "То разновидность кимчи, в приготовлении которого используются почти те же ингредиенты, что и для классического кимчи.",
            price: 195
        },
        {
            id: 9,
        ...
        },
        {
            ...
            mass: 550,
            description: "Блюдо состоит из отварного белого риса, покрытого овощным салатом намуль, пасты из острого перца кочхуджан, яичницы и тонко нарезанных кусочков говядины. Ингредиенты перемешиваются непосредственно перед употребление блюда.",
            price: 470
        },
        {
            id: 16,
        ...
        },
        {
            ...
            mass: 240,
            description: "Авторский ролл с добавлением гребешка, сливочный сыра, лосося, мосаго, огуреца, спайси соуса и кунжута.",
            price: 540
        },
        {
            id: 18,
